          ...
          <div className="form-image-content">
            <div className="form-image-icon">
              <svg viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M60 30c-16.5 0-30 13.5-30 30s13.5 30 30 30 30-13.5 30-30-13.5-30-30-30zm0 50c-11 0-20-9-20-20s9-20 20-20 20 9 20 20-9 20-20 20z" fill="white"/>
                <circle cx="60" cy="60" r="12" fill="white"/>
              </svg>
            </div>
            <h1>Welcome Back!</h1>
            <p>Sign in to access your account and continue your shopping journey with exclusive deals and personalized recommendations.</p>
